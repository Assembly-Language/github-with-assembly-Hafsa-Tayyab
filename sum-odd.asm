...
;   Write an assembly program to find the sum of all odd numbers in an array.
...
LoopAllElements: 
    ...
    test ax, 1h                         ; If this test results in 1, then the number is odd.                     
    jz skipAddition                     ; Otherwise it's not and we'll skip addition and counting.      
    add sum,ax                          ; Adding odd number to the sum.
