...
;   Write an assembly program to find the sum of all positive numbers in an array.
...
LoopAllElements: 
    ...
    test ax, 8000h                      ; If this test results in 0, then the number is positive.                     
    jnz skipAddition                    ; Otherwise it's not and we'll skip addition and counting.      
    add sum,ax                          ; Adding positive number to the sum.
